...
const Footer = () => {
    return (
        <div>
            <section class="footer6 cid-sEELpHV0RX" once="footers" id="footer6-12">
                <div class="container">
            ...
            <section style={{backgroundColor: '#fff', color: '#aaa', fontSize: '12px', padding: 0, alignItems: 'center', display: 'flex'}}>
                <a href="https://mobirise.site/n" style={{flex: '1 1', height: '3rem', paddingLeft: '1rem'}}>
                </a>
                {/* <p style={{flex: '0 0 auto', margin: 0, paddingRight: '1rem'}}>Made with 
                <a href="https://mobirise.site/a" style={{color:'#aaa'}}>Mobirise</a></p> */}
            </section>
        </div>
    )
}
